...
const RetreatCard = ({ retreat, onHide }: RetreatCardProps) => {
  ...
  return (
    <div className="max-w-sm rounded overflow-hidden shadow-lg my-4 flex flex-col">
      ...
      <div className="px-4 py-2 flex-grow">
        ...
        <div className="grid grid-cols-1 text-gray-800 mt-3">
          <div>
      ...
      <div className="mt-auto text-right mr-4 mb-4">
        <Button
          contents={<BiHide />}
          classes="p-2 rounded-full bg-gray-200 hover:bg-gray-300 text-gray-700 hover:text-gray-800 focus:outline-none transition duration-300"
